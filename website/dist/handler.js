...
var pathRegexp = __webpack_require__(78);
...
const binarycase = __webpack_require__(42)
...
var _awsServerlessExpress = __webpack_require__(38);
...
var server = _awsServerlessExpress2.default.createServer(_server2.default);

var hello = exports.hello = function hello(event, context) {
...
var mime = send.mime;
var resolve = path.resolve;
var vary = __webpack_require__(85);
...
mime.define(__webpack_require__(72));
